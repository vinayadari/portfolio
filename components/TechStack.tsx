...
export default function TechStack() {
  ...
  return (
    <section id="tech-stack" className="relative py-24 px-6 bg-[#111827]" ref={ref}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-12">
          {Object.entries(techStack).map(([category, skills], categoryIndex) => (
            ...
            >
              <h3 className="text-xl font-semibold mb-6 text-[#9CA3AF]">
                {category}
              </h3>
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col items-center gap-3">
                        <Icon className="w-10 h-10 text-[#38BDF8] group-hover:text-[#8B5CF6] transition-colors" />
                        <span className="text-sm font-medium text-[#E5E7EB] text-center">
                          {skill.name}
                        </span>
                      </div>
                    </motion.div>
