      ...
      {insights.map((insight, index) => {
        ...
        return (
          <motion.div
            ...
            className="group glass-card rounded-2xl p-8 interactive-card border border-white/5 hover:border-white/10 transition-all duration-300"
          >
            ...
            <h3 className="text-xl font-bold text-white mb-3 group-hover:text-[#38BDF8] transition-colors" style={{ fontWeight: 700 }}>
              {insight.title}
            </h3>

            <p className="text-[#9CA3AF] leading-relaxed text-sm" style={{ fontWeight: 400, lineHeight: 1.7 }}>
              {insight.description}
            </p>
          </motion.div>
        );
