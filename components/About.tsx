...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-[#111827]" ref={ref}>
      <div className="max-w-7xl mx-auto">
        ...
        >
          <p className="label-text text-[#38BDF8] mb-3 sm:mb-4 font-semibold tracking-wider text-xs sm:text-sm">ENGINEERING APPROACH</p>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight" style={{ fontWeight: 700 }}>
            How I think about building backend systems
          </h2>
          <p className="text-base sm:text-lg text-[#9CA3AF] mt-4 sm:mt-6 max-w-3xl" style={{ lineHeight: 1.7 }}>
        ...
        >
          <div className="grid sm:grid-cols-2 gap-5 sm:gap-6">
            <div className="glass-card rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-[#38BDF8]/10 hover:border-[#38BDF8]/30 transition-all duration-300">
            ...
            <div className="glass-card rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-[#8B5CF6]/10 hover:border-[#8B5CF6]/30 transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-white mb-3" style={{ fontWeight: 700 }}>What I Prioritize</h3>
